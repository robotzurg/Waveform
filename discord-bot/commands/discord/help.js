...
const data = new SlashCommandBuilder()
    ...
    data.help_desc = `Get help with all the various Waveform commands, and view guides on how to do song/EP/LP reviews and use Waveform Mailbox.`;
async function execute(interaction, client) {
    ...
    const commandEmbed = new EmbedBuilder()
        ...
        .addFields({ name: `Description`, value: `${commandList[0][1].data.help_desc}` });
    ...
    help_collector.on('collect', async (i) => {
        ...
        switch (sel) {
            ...
            case 'right':
                ...
                page_num = clamp(page_num, 0, sel_guide_pages.length - 1);
            ...
            default:
                ...
                commandEmbed.addFields({ name: `Description`, value: `${commandList[cmd_idx][1].data.help_desc}` });

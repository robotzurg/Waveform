...
module.exports = {
	...
	async execute(interaction) {
        ...
        .then(function(data) {
            ...
            interaction.reply(`Your mailbox has now been setup on Spotify, and \`/sendmail\` can now be used with it!\n` + 
            ...
            interaction.reply(`Something went wrong with your mailbox creation, you should probably let Jeff know!`);
